...
function prepare_config {
  ...
  wget -qO ${HOME}/${WORKSPACE}/docker-compose.yaml https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/aptos/docker-compose.yaml
  wget -qO ${HOME}/${WORKSPACE}/validator.yaml https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/aptos/validator.yaml
  wget -qO ${HOME}/${WORKSPACE}/fullnode.yaml https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/aptos/fullnode.yaml
}
