...
echo "-----------------------------------------------------------------------------"
curl -s curl -s https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/docker.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/ufw.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/rust.sh | bash &>/dev/null
...
wget -O $HOME/.archway/config/genesis.json "https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/archway/genesis.json"
wget -qO $HOME/.archway/config/addrbook.json https://raw.githubusercontent.com/bogdankornij/avangard-nodes/master/archway/addrbook.json &>/dev/null
